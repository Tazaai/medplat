#!/bin/bash
echo "🍽️ Generating Gastroenterology Firestore insert commands..."
...
for entry in "${topics[@]}"; do
  topic="${entry%%|*}"
  id="${entry##*|}"
  echo "firebase.firestore().doc('topics2/$id').set({"
  echo "  category: 'Gastroenterology',"
  echo "  topic: '$topic',"
  echo "  id: '$id',"
  echo "  lang: 'en'"
  echo "});"
...
echo "✅ All Gastroenterology insert commands generated."
